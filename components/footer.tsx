...
const footerLinks: Record<string, FooterLink[]> = {
  Platform: [
    ...
    { name: "YC Requests for Startups", href: "/yc-rfs" },
  ],
  Explore: [
    { name: "VCs", href: "/landscape" },
...
const socialLinks: { name: string; href: string; icon: React.ReactNode }[] = [
  {
    name: "Twitter",
    href: "https://twitter.com/openquest",
    icon: (
  ...
  {
    name: "Discord",
    href: "https://discord.gg/openquest",
    icon: (
      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  {
    name: "GitHub",
    href: "https://github.com/openquest",
    icon: (
      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        <path
          fillRule="evenodd"
      ...
      <div className="mx-auto max-w-7xl px-6 py-12 md:py-16">
        ...
        <div className="mt-12 flex flex-col items-center gap-4 border-t border-border/40 pt-8 md:flex-row md:justify-between">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} OpenQuest. All rights reserved.
          </p>
